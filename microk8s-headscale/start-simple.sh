...
export HEADSCALE_NAMESPACE INGRESS_CLASS_NAME TLS_SECRET_NAME HEADSCALE_IMAGE HEADPLANE_IMAGE HEADSCALE_HOST HEADPLANE_HOST HEADSCALE_DNS_NAMESERVER HEADSCALE_DB_HOST HEADSCALE_DB_PORT HEADSCALE_DB_NAME HEADSCALE_DB_USER HEADSCALE_DB_PASSWORD
